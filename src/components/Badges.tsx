    ...
    <footer className="bg-card text-card-foreground py-4 mt-aut mb-3">
      <div className="flex justify-center items-center">
          ...
          <a href="https://abusosupremo.vercel.app" className='display-inline-block m-2'>
            <img
              src="https://img.shields.io/badge/ABUSO%20SUPREMO-351d1d?logo=msi&logoColor=00aced&style=flat"
              alt="ABUSO SUPREMO"
            />
          </a>
          <a href="https://futuroroubado.vercel.app" className='display-inline-block m-2'>
            <img
              src="https://img.shields.io/badge/FUTURO%20ROUBADO-417547?logo=redragon&logoColor=00aced&style=flat"
              alt="FUTURO ROUBADO"
            />
          </a>
          <a href="https://abusofederal.vercel.app" className='display-inline-block m-2'>
            <img
              src="https://img.shields.io/badge/ABUSO%20FEDERAL-00295b?logo=diagramsdotnet&logoColor=00aced&style=flat"
              alt="ABUSO FEDERAL"
            />
          </a>
      </div>
