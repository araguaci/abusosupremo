...
export const censorshipData: CensorshipData = {
  ...
  "events": {
    ...
    "2021": [
      {
        "date": "Agosto",
        "description": "Tribunal Superior Eleitoral (TSE), ministro Luis Felipe Salomão, contra a monetização de propagadores de mensagens falsas sobre as eleições atinge perfis ligados a 11 influenciadores digitais, três veículos de mídia (Terça Livre, Folha Política e Jornal da Cidade Online) e um movimento político (Nas Ruas).",
        "type": "judicial",
        "target": "bolsonaristas",
